...
CodeMirror.defineMode("go", function(config) {
  ...
  var keywords = {
    ...
    // Secret keywords (Hehe... 💩).
    "despiteallobjections":true, "insofaras":true, "notwithstanding":true,
    "thetruthofthematter":true, "whereas":true,
  };

  var builtin = {
    // Predeclared types.
    "bool":true, "byte":true, "complex128":true, "complex64":true, "error":true,
    "float32":true, "float64":true, "rune":true, "string":true, "uintptr":true,
